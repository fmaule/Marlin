/**
   ...
   This program is free software: youn can redistribute it and/or modify
...
#define STRING_CONFIG_H_AUTHOR "(Fernando Maule - based on Bob Kuhn Anet cfg)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pimped Printer"
...
// Gradually reduce leveling corunifrection until a set height is reached,
